...
- [x] `T-001` — Establish green baseline and failing canonical acceptance test
...
- [x] `T-002` — Correct all shared-item fixtures/contracts
  ...
  - Likely scope: `PRODUCT.md`, product plan, `docs/agent/android-engineering.md`, `ARCHITECTURE.md`, `billslice.pen`, fixtures.
...
- [x] `T-003` — Implement exact models and typed validation test-first
  ...
  - Depends on: `T-002`
- [x] `T-004` — Implement deterministic calculation use case
  ...
  - Depends on: `T-003`
- [x] `T-005` — Implement validation and share-text use cases
  ...
  - Depends on: `T-004`
- [x] `T-006` — Add shared test fixtures when domain and feature both consume them
  - Covers: `AC-003`
  ...
  - Depends on: `T-005`
- [x] `T-007` — Implement Manual Entry and editable session state
...
- [x] `T-008` — Implement people, payer, and one-owner assignment
  ...
  - Depends on: `T-007`
- [x] `T-009` — Implement Summary, Result, and Share Preview
...
- [x] `T-010` — Cover failures, restoration, and boundary values
  ...
  - Depends on: `T-009`
- [x] `T-011` — Run targeted and aggregate verification
  - Covers: `AC-009`
  ...
  - Depends on: `T-010`
- [x] `T-012` — Inspect six actual screens and capture evidence
  ...
  - Depends on: `T-011`
- [x] `T-013` — Review the complete diff against spec and standards
  ...
  - Depends on: `T-012`
- [x] `T-014` — Perform final acceptance-criteria verification
  - Covers: `AC-001`–`AC-009`
...
- [x] `AC-001`–`AC-009` evidenced.
- [x] Canonical one-owner totals pass pure, UI, and actual-app checks.
- [x] Tests/compile/lint/build/Fastlane/CI/review pass with no blocking finding.
